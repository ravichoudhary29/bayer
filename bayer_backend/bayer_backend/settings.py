"""
Django settings for bayer_backend project.
...
SECRET_KEY = 'django-insecure-!xvf*v(n0mtwzfk#yi#3^-%vpt*v=k-lig)7)43%asu)5g8wzu'
...
WSGI_APPLICATION = 'bayer_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bayers_db',         # The name of your database
        'USER': 'admin',          # Your PostgreSQL username
        'PASSWORD': 'admin123', # Your PostgreSQL password (if set)
